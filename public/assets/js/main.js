...
(function ($) {
  ...
  var sasna = {
    ...
    sliderActivations: {
      ...
      brandlogoSliderActivationv4: function () {
        $(".brandlogo-slider-v4").slick({
          infinite: true,
          autoplay: true,
          autoplaySpeed: 5000,
          slidesToShow: 5,
      ...
      init: function () {
        ...
        sasna.sliderActivations.teamSliderActivation();
        sasna.sliderActivations.brandlogoSliderActivationv4();
      },
    },
      ...
      $(".blogitem").each(function () {
        $(this)
          .on("mouseover", function () {
            $(this)
              .find(".blogitem-content")
              .find(".tm-button")
              .removeClass("tm-button-dark");
          })
          .on("mouseout", function () {
            $(this)
              .find(".blogitem-content")
              .find(".tm-button")
              .addClass("tm-button-dark");
          });
      });
    },
    ...
    productDetailsColorSize: function () {
      $(".tm-prodetails-color ul li, .tm-prodetails-size ul li").on(
        "click",
        "span",
        function (e) {
          e.preventDefault();
    ...
    checkoutPaymentMethod: function () {
      $('.tm-checkout-payment input[type="radio"]').each(function () {
        ...
        $(this)
          .siblings("label")
          .on("click", function () {
            $('.tm-checkout-payment input[type="radio"]')
              .prop("checked", false)
