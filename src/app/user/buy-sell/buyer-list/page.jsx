...
const Orders = () => {
  ...
  return (
    <>
      <Header />
      <OtherBanner page_title="Apply List (Buy/Sell)" banner_image="/assets/images/bg/furniture_banner.jpg" />

      <section className="py-5 bg-light">
        <div className="container">
          <h2 className="fw-bold mb-4 text-center">Apply List (Buy/Sell)</h2>

          {orderList.length === 0 ? (
            <p className="text-center">You haven’t contacted any seller.</p>
          ) : (
                    ...
                    <tr key={order.id} className="text-center">
                      ...
                      <td>
                        <button
                          ...
                          title="View Details"
                          onClick={() => router.push(`/user/orders/details`)}
