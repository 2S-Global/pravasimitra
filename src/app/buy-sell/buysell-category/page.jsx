...
const MarketPlaceCategory = () => {
  ...
  const handleClick = (category) => {
    ...
    router.push(`/buy-sell/${slug}`)
  }

  const categories = [
    { id: 1, label: "Home Furniture", image: "/assets/images/furniture.png" },
    { id: 2, label: "Office Furniture", image: "/assets/images/officefrniture.png" },
    { id: 3, label: "Electronics", image: "/assets/images/electronicsgoods.png" },
    { id: 4, label: "Clothing", image: "/assets/images/football-uniform.png" },
    { id: 5, label: "Vehicles", image: "/assets/images/vehicles.png" },
    { id: 6, label: "House Holds", image: "/assets/images/household.png" },
  ]

  return (
    <>
      <Header />
      <OtherBanner page_title="Buy & Sell" banner_image="/assets/images/bg/furniture_banner.jpg" />
