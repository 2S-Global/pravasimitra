          ...
          <div className="row g-5 align-items-start">
            ...
            <div className="col-md-6">
              ...
              <p className="text-secondary mb-1">
                Category: <strong className="text-dark">Furniture</strong>
              </p>
              ...
              <p className="text-muted mb-4">
                Maximize your bedroom space with this elegant wood bed featuring
                built-in side storage. Its timeless design blends functionality
                with classic charm.
              </p>
              ...
              >
                ...
                >
                  <p className="text-muted">
                    Upgrade your living space with this modern L-shaped sofa
                    set, combining style and comfort. Its sleek design fits
                    perfectly in any corner, maximizing space while offering
                    ample seating. Crafted with premium materials, it's ideal
